    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden pt-10 pb-20 lg:pt-32 lg:pb-32 bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-950">
            ...
            <div className="flex flex-col items-center justify-center text-center">
              <div className="max-w-4xl space-y-8 animate-in slide-in-from-bottom duration-700 fade-in zoom-in-95">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                  <Button asChild size="xl" className="w-full sm:w-auto text-lg h-12 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
                    <Link href="/login">Commencer maintenant</Link>
                  </Button>
                  <Button asChild variant="outline" size="xl" className="w-full sm:w-auto text-lg h-12 px-8 rounded-xl backdrop-blur bg-white/50 hover:bg-white/80 dark:bg-gray-900/50">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-400/20 rounded-full blur-[100px] -z-10 pointer-events-none"></div>
        </section>
