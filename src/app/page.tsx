  ...
  return (
    <>
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative overflow-hidden pt-10 pb-20 lg:pt-20 lg:pb-28 bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-950">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="flex-1 text-center lg:text-left space-y-8 animate-in slide-in-from-left duration-700">
                <div className="inline-flex items-center rounded-full border px-3 py-1 text-sm font-medium bg-white/50 backdrop-blur text-blue-600 dark:bg-white/10 dark:text-blue-400">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white leading-tight">
                  L&apos;excellence académique <span className="text-blue-600 inline-block relative">
                    digitale
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                  Campus Master 2 transforme l&apos;expérience éducative à l&apos;Université numérique Cheikh Hamidou Kane. Gestion simplifiée, apprentissage enrichi.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                  <Button asChild size="xl" className="w-full sm:w-auto text-lg h-14 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
                    <Link href="/login">Commencer maintenant</Link>
                  </Button>
                  <Button asChild variant="outline" size="xl" className="w-full sm:w-auto text-lg h-14 px-8 rounded-xl backdrop-blur bg-white/50 hover:bg-white/80 dark:bg-gray-900/50">
              ...
              <div className="flex-1 relative animate-in fade-in zoom-in duration-1000 delay-200">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900">
                  <Image
                    src="/home-hero.png"
                    alt="Campus Master Digital Learning"
                    width={800}
                    height={600}
        ...
        <section id="features" className="py-24 bg-gray-50 dark:bg-gray-900">
          <div className="container mx-auto px-12">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-blue-600 font-semibold tracking-wide uppercase mb-3">Pourquoi Campus Master ?</h2>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Découvrez les outils puissants qui rendent l&apos;apprentissage et la gestion plus efficaces que jamais.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              {aboutCampusMaster.map((item, index) => (
                <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-none shadow-md bg-white dark:bg-gray-800 overflow-hidden">
                  <CardContent className="p-8">
                    <div className="w-14 h-14 rounded-2xl bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                      <div className="text-blue-600 dark:text-blue-400">
                        {/* We use a generic icon here as the data source doesn't have icon info yet, or we can map it */}
